...
import RuseltList from "./RuseltList";
...
const Results = () => {
    ...
    const paginatedResults = searchResults.filter(e=>e.des.indexOf(query)!=-1).slice(startIndex, endIndex);
    console.log(paginatedResults);
    let numberOfResults=paginatedResults.length;
    return (
